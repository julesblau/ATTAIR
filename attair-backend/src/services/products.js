...
export async function findProductsForItems(items, gender, budgetMin, budgetMax, imageUrl, sizePrefs = {}, occasion = null, searchNotes = null, customOccasionModifiers = null, searchMode = "fast", preferenceProfile = null, hangerTaste = null) {
  ...
  // Style match scoring is now handled by styleMatch.js service,
  // called from the findProducts route after this function returns.
  // This allows the route to inject Style DNA data alongside the
  // preference profile for richer scoring (archetype overlap,
  // price tier alignment, category preference).
