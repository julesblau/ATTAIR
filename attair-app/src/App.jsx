      ...
      {screen === "auth" && (
        <div className={`auth ${fade}`}>
          ...
          {import.meta.env.VITE_APPLE_AUTH_ENABLED === "true" && (
            <button onClick={() => API.oauthLogin("apple")} style={{ width: "100%", padding: "14px 18px", background: "rgba(255,255,255,.04)", border: "1px solid rgba(255,255,255,.08)", borderRadius: 12, color: "#fff", fontFamily: "'Outfit'", fontSize: 14, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, marginBottom: 8, transition: "all .2s" }}>
            ...
            <div className="animate-fade-in" style={{ paddingBottom: 80 }}>
              ...
              <div style={{ padding: "12px 16px" }}>
                ...
                {userSearchResults.map(usr => {
                  ...
                  return (
                    <div key={usr.id} style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 0", borderBottom: "1px solid var(--border)", cursor: "pointer" }} onClick={() => { /* future: open profile overlay */ }}>
