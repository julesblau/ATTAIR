...
export default function App() {
  ...
  return (<>
    ...
    <div className="app" data-theme={["onboarding","inspo","paywall","auth"].includes(screen) ? "dark" : theme}>
      ...
      {screen === "app" && (<>
        <div className="hdr">
          <><img src="/logo.png" alt="ATTAIRE" className="logo-img logo-img--dark" /><img src="/logo-dark-text.png" alt="ATTAIRE" className="logo-img logo-img--light" /></>
      ...
      {publicScanView && (
        <div style={{ position: "fixed", inset: 0, zIndex: 9999, background: "var(--bg-secondary, #0C0C0E)", display: "flex", flexDirection: "column", overflow: "auto" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "14px 20px", borderBottom: "1px solid var(--border)" }}>
            <><img src="/logo.png" alt="ATTAIRE" className="logo-img logo-img--dark" loading="lazy" /><img src="/logo-dark-text.png" alt="ATTAIRE" className="logo-img logo-img--light" loading="lazy" /></>
